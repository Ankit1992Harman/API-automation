package com.mindtickle.qa.listener;


import com.mindtickle.qa.util.DateUtil;
import com.mindtickle.qa.util.ExtentManager;
...
public class TestListener implements ITestListener,ISuiteListener,IInvokedMethodListener {
	...
	public void onStart(ITestContext context) {
		...
		try {
			File file = new File(System.getProperty("user.dir") + System.getProperty("file.separator") + PropertiesUtil
          .getConstantProperty("ReportPath"));
          ...
          .getInstance(testReportCompleteName.get(testReportCompleteName.size() - 1));
